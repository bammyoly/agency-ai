...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
      ...
      <div className={`text-gray700 dark:text-white sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' : 
        ...
        <a href='#our-work' onClick={()=> setSidebarOpen(false)} className='sm:hover:border-b'>Our Works</a>
        <a href='#contact' onClick={()=> setSidebarOpen(false)} className='sm:hover:border-b'>Contact Us</a>
      </div>
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <a href='#contact' className='text-sm max-sm:hidden flex items-center gap-2 bg-primary text-white 
